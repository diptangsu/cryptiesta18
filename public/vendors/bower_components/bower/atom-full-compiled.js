...
*/
    ...
    atom.Transition.Linear = atom.Transition(function (p) {
        return p
    }, true);
        ...
        atom.string = {
            ...
            replaceAll: function (string, find, replace) {
                if (toString.call(find) == '[object RegExp]') {
                    return string.replace(find, function (symb) {
                        return replace[symb];
                    });
