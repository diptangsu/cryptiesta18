...
<section>
    ...
    <div class="view">
        ...
        <p>noUiSlider is a range slider <strong>without bloat</strong>. It offers a ton off <strong>features</strong>,
            and it is as small, <strong>lightweight</strong> and minimal as possible, which is great for mobile use on
            the many supported <strong>devices</strong>, including iPhone, iPad, Android devices &amp; Windows (Phone) 8
            desktops, tablets and all-in-ones. It works on desktops too, of course!</p>
...
<section>
    ...
    <div class="view">
        ...
        <p>noUiSlider works with pretty much any device, mouse, touchscreen or both, and it'll work beautifully in
            <strong>responsive designs</strong>. Have you tried this documentation on your phone?</p>
    </div>
    ...
    <div class="side">
        ...
        <p>Putting all your scripts in the page <code>&lt;head&gt;</code> will slow down your site. If you'd like to
            know why, consider reading <a href="http://developer.yahoo.com/performance/rules.html#js_bottom">this
                article by Yahoo!</a>. Put the slider CSS in your <code>&lt;head&gt;</code>, and the script at the end
...
&lt;script src="nouislider.min.js"&gt;&lt;/script&gt;</code></pre>
        ...
        <p>noUiSlider supports <strong>IE9 and up</strong>, and the latest versions of <strong>Edge</strong>, <strong>Chrome</strong>,
            <strong>Safari</strong>, <strong>Firefox</strong> and <strong>Opera</strong>.</p>
